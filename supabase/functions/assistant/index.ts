  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        contactName: {
          type: 'STRING',
          description: 'اسم جهة الاتصال. طابقه بقائمة السياق إن أمكن.',
        },
...
function buildSystemInstruction(context: RequestBody['context']): string {
  ...
  return [
    ...
    '- لا تخترع اسم جهة اتصال؛ إن لم تجده في القائمة فاسأل عنه.',
    '- لا تنفّذ إلا ما طُلب. لا تسجّل حركة لم يذكرها المستخدم صراحةً.',
    '- إن كان الطلب غامضاً أو ناقص مبلغ أو اسم، اسأل سؤالاً واحداً محدّداً.',
    '',
